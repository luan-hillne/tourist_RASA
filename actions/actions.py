...
chonoicairang_arr = ["chợ nổi cái răng cần thơ", "chợ nổi cái răng", "chợ nổi","chợ nổi cái"]
...
vuoncobanglang_arr = ["vườn cò bằng lăng", "vườn cò","vườn", "vuon co bang lang"]
restaurant_arr=["quán ăn ","nhà hàng buffet","buffet","nhà hàng","quán ăn vặt","quán cà phê","món chay","cho an uong","chỗ ăn","mon an","dac san","cho an","restaurant","hủ tiếu ngon","món đặc trưng miền Tây","quán ăn hải sản","nhà hàng trên sông","quán ăn","nhà hàng","món ăn","món chay","địa điểm ăn uống","món ăn nổi bật","mon chay","mon an ngon","quán bún","quán cơm","cơm"]
...
def main(question):
    ...
    system_prompt = "Bạn là một hướng dẫn viên du lịch giàu kinh nghiệm ở Cần Thơ. Hãy trả lời câu hỏi về các điểm du lịch, nhà hàng, và hoạt động giải trí với sự thân thiện và chi tiết."
...
class ActionExtractLocation(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        # Kiểm tra từng địa điểm và dịch vụ
        if location_entity:
                ...
                if location_entity in globals().get(location_arr, []):
                    ...
                    for entity_type, entity_value in other_entities.items():
                        if entity_value:
                            ...
                            response_sent = True
                            break  # Phản hồi đầu tiên phù hợp, không cần kiểm tra thêm
        else :
